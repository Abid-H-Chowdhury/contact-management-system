<?php /** Configuration file; f0ska xCRUD v.1.7; 03/2022 */

$conPath = realpath(__DIR__ . '/../config.php');
...
class Xcrud_config
{
    ...
    // editor
    public static $editor_url = SITE_URL.'includes/tinymce/tinymce.min.js'; // URL path to editor script, if you want to use the visual editor.
    ...
    // alert settings
    public static $email_from = 'no-reply@esteemsoftbd.com'; // email from address
    public static $email_from_name = 'Esteem Soft Ltd'; // email from name
